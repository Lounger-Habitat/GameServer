...
class ModelInfo(BaseModel):
    ...
    supports: Dict[str, bool] = Field({"streaming": True,"image": False,"audio": False,"file": False}, description="能力支持")
    price: Optional[Dict[str, float]] = Field({"input":"","cache_input":"","output":""}, description="模型价格")
