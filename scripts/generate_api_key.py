...
from gameserver.utils.auth.api_auth import create_api_key, API_KEY_FILE
...
def parse_args():
    ...
    parser.add_argument(
        "--save", action="store_true", help="是否保存到api_keys.yaml文件", default=True
    )
...
def main():
    ...
    if args.save:
        ...
        # 添加新的API Key
        api_keys[api_key] = {"username": args.username}
